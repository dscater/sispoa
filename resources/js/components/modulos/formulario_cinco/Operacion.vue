                            ...
                            <div class="row mt-3">
                                ...
                                <div class="row pr-1">
                                    <div class="col-md-12">
                                        ...
                                        <div
                                            class="row mt-3 mb-1 fila_tarea border pt-3"
                                            v-for="(
                                                tarea, index_tarea
                                        ...
                                        >
                                            <span
                                                class="numero_operacion_detalle_tarea bg-lime"
                                                v-text="
                                                    index_tarea +
                                                    1 +
                                                    ') Actividad'
                                            ...
                                            <div
                                                class="col-md-2 form-group mb-1"
                                            >
                                                        ...
                                                        >
                                                            ...
                                                            <input
                                                                ...
                                                                v-model="
                                                                    partida.partida
                                                                "
                                                                class="form-control bg-gray-dark"
                                                            />
                                                        </div>
                                                        <div
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12">
                            <button
                                class="btn btn-danger btn-flat btn-block secondary"
